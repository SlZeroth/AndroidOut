...
package com.pjcstudio.serialcam.usbserial.driver;
        ...
        public int read(byte[] dest, int timeoutMillis) throws IOException {
            ...
            if (ENABLE_ASYNC_READS) {
                ...
                if (payloadBytesRead > 0) {
                    //Log.d(TAG, com.pjcstudio.serialcam.usbserial.driver.HexDump.dumpHexString(dest, 0, Math.min(32, dest.length)));
